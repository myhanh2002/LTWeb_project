			...
			<div class="col-lg-3 d-none d-lg-block">
				...
				<nav
					...
					<div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
						<a href="" class="nav-item nav-link">Hoa sinh nhật</a> <a href=""
							class="nav-item nav-link">Hoa chúc mừng</a> <a href=""
							class="nav-item nav-link">Hoa tình yêu</a> <a href=""
							class="nav-item nav-link">Hoa cưới</a> <a href=""
							class="nav-item nav-link">Hoa khai trương</a> <a href=""
							class="nav-item nav-link">Hoa chia buồn</a>
					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav ml-auto py-0">
							<a href="" class="nav-item nav-link">Đăng nhập</a> <a href=""
								class="nav-item nav-link">Đăng kí</a>
						</div>
					</div>
				</nav>
		...
		<div class="row px-xl-5 pb-3">
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<p class="font-weight-semi-bold m-0">Hoa sinh nhật</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<p class="font-weight-semi-bold m-0">Hoa chúc mừng</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<p class="font-weight-semi-bold m-0">Hoa tình yêu</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<p class="font-weight-semi-bold m-0">Hoa cưới</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<p class="font-weight-semi-bold m-0">Hoa khai trương</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<p class="font-weight-semi-bold m-0">Hoa chia buồn</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid bg-secondary text-dark mt-5 pt-5">
		<div class="row px-xl-5 pt-5">
			<div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
				...
				<p>Một đóa hoa đẹp tặng bạn bằng một vạn lời chúc hay.</p>
				<p class="mb-2">
					<i class="fa fa-map-marker-alt text-primary mr-3"></i>Trường ĐH Nông Lâm TP.HCM,
